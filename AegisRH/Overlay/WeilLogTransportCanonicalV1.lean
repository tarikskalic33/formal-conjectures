...
Authoritative source:
  ...
  sovereign-omega-v2/formal/bridges/lean/WeilLogTransportCanonicalV1.lean
  source blob: fd1a2d1e9f45a63b17d8ecd4ee1b901844078776

Only command ordering is changed so Lean 4.33.1 accepts the module. The theorem
statements and proof bodies below are the source content.
-/
